      ...
      <div className="min-h-screen bg-hivewire-yellow flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <Card className="max-w-md w-full p-8 bg-white">
          <div className="flex flex-col items-center justify-center">
            ...
            <h2 className="text-center text-xl font-bold text-hivewire-dark">Welcome back to HiveWire Tribe</h2>
            <LoginForm />
            <div className="mt-4 text-center text-sm">
              <span className="text-gray-600">Don't have an account? </span>
              <Link to="/register" className="font-medium text-hivewire-dark hover:underline">
                Sign up
              </Link>
            </div>
          </div>
